  ...
  for(int xa = 0; xa < numVoxX; ++xa)
	...
	*/
	...
	//if (false) {
	  ...
	  //} else {
#else
	  float widthb1y   ( widtha );  // New width of current voxel, y, in vol1.
	  float widthb2y   ( widtha );  // New width of current voxel, y, in vol2.
	  
	  float widthb1yp  ( widtha );  // New width of voxel yp in vol1.
	  float widthb2yp  ( widtha );  // New width of voxel yp in vol2.	
	  
	  float widthb1ym  ( widtha );  // New width of voxel ym in vol1.
	  float widthb2ym  ( widtha );  // New width of voxel ym in vol2.		  
	  //}
#endif
...
#else
	  //float dwidthb1yddym   ( -voxStepInv );
	  float dwidthb1yddyp   (  0 );
	  
	  //float dwidthb2yddym   (  voxStepInv );
	  float dwidthb2yddyp   ( -0 );
	  
	  float dwidthb1ypddy   ( -0 );
	  float dwidthb1ypddypp (  0 );
	  
	  float dwidthb2ypddy   (  0 );
	  float dwidthb2ypddypp ( -0 );
	  
	  //float dwidthb1ymddymm ( -voxStepInv );
	  float dwidthb1ymddy   (  0 );
	  
	  //float dwidthb2ymddymm (  voxStepInv );
	  float dwidthb2ymddy   ( -0 );
	  //}
#endif
